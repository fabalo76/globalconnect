...
import com.uic.uicpaymentapp.navigation.CHECK_IN_ID_KEY
import com.uic.uicpaymentapp.navigation.FOLIO_KEY
import com.uic.uicpaymentapp.navigation.NavigationManager
import com.uic.uicpaymentapp.navigation.ORIGINAL_TRANSACTION_ID_KEY
import com.uic.uicpaymentapp.navigation.dst_Batch
import com.uic.uicpaymentapp.navigation.dst_Sale
import com.uic.uicpaymentapp.navigation.dst_CardTransaction
import com.uic.uicpaymentapp.navigation.DESTINATION_KEY
import com.uic.uicpaymentapp.navigation.dst_CheckIn
import com.uic.uicpaymentapp.navigation.dst_CheckInReport
import com.uic.uicpaymentapp.navigation.dst_CheckOut
import com.uic.uicpaymentapp.navigation.dst_EditTransaction
import com.uic.uicpaymentapp.navigation.dst_EndOfDay
import com.uic.uicpaymentapp.navigation.dst_MoreMenu
import com.uic.uicpaymentapp.navigation.ReportShortcut
import com.uic.uicpaymentapp.navigation.dst_PasswordScreen
import com.uic.uicpaymentapp.navigation.dst_QuickTip
import com.uic.uicpaymentapp.navigation.dst_Refund
import com.uic.uicpaymentapp.navigation.dst_Reports
import com.uic.uicpaymentapp.navigation.NewTransactionMenuScreen
import com.uic.uicpaymentapp.navigation.dst_NewTransaction
import com.uic.uicpaymentapp.navigation.dst_Signature
import com.uic.uicpaymentapp.navigation.dst_SystemSettings
import com.uic.uicpaymentapp.navigation.TAX1_KEY
import com.uic.uicpaymentapp.navigation.TAX2_KEY
import com.uic.uicpaymentapp.navigation.TIP_KEY
import com.uic.uicpaymentapp.navigation.TRANSACTION_ID_KEY
import com.uic.uicpaymentapp.navigation.TRANSACTION_TYPE_KEY
import com.uic.uicpaymentapp.navigation.dst_TipScreen
import com.uic.uicpaymentapp.navigation.dst_Cash
import com.uic.uicpaymentapp.navigation.dst_CardReaderTest
import com.uic.uicpaymentapp.navigation.dst_ApplicationInfo
import com.uic.uicpaymentapp.navigation.dst_EchoTest
import com.uic.uicpaymentapp.navigation.dst_TerminalCounters
import com.uic.uicpaymentapp.navigation.dst_ExtrasSale
import com.uic.uicpaymentapp.navigation.dst_LoyaltySale
import com.uic.uicpaymentapp.navigation.dst_Payment
import com.uic.uicpaymentapp.navigation.dst_QuotaSale
import com.uic.uicpaymentapp.navigation.dst_ReportAudit
import com.uic.uicpaymentapp.navigation.dst_ReportTotals
import com.uic.uicpaymentapp.navigation.dst_ReportReprintSettlement
import com.uic.uicpaymentapp.navigation.dst_TransactionFinished
import com.uic.uicpaymentapp.navigation.dst_Transactions
import com.uic.uicpaymentapp.navigation.dst_AppConfig
import com.uic.uicpaymentapp.navigation.UICNavigationBar
import com.uic.uicpaymentapp.navigation.UICDestination
import com.uic.uicpaymentapp.navigation.navBarScreens
import com.uic.uicpaymentapp.printer.NexGoPaymentPrinter
import com.uic.uicpaymentapp.printer.PaymentPrinter
import com.uic.uicpaymentapp.profile.settingNavGraph
import com.uic.uicpaymentapp.signature.SignatureScreen
import com.uic.uicpaymentapp.transaction.AmountPromptConfig
import com.uic.uicpaymentapp.transaction.ONSCREEN
import com.uic.uicpaymentapp.transaction.HostProcessingStateMachine
import com.uic.uicpaymentapp.transaction.ProcessingStatusStrings
import com.uic.uicpaymentapp.transaction.SaleScreen
import com.uic.uicpaymentapp.transaction.TipScreen
import com.uic.uicpaymentapp.transaction.BrandingAnimationScreen
import com.uic.uicpaymentapp.transaction.TransactionFinishedScreen
import com.uic.uicpaymentapp.profile.PREF_CAPTURE_SIGNATURE
...
import com.uic.uicpaymentapp.settlement.SettlementCoordinator
import com.uic.uicpaymentapp.settlement.SettlementProcessingDialog
import com.uic.uicpaymentapp.settlement.SettlementResult
import com.uic.uicpaymentapp.transaction.SettlementProcessingState
import com.uic.uicpaymentapp.transaction.SettlementResultsUiState
...
import com.uic.uicpaymentapp.utils.LocalLanguageViewModel
import com.uic.uicpaymentapp.utils.SoundEffect
import com.uic.uicpaymentapp.utils.SoundManager
import com.uic.uicpaymentapp.utils.getSavedLanguage
import com.uic.uicpaymentapp.utils.setLocale
...
class MainActivity : ComponentActivity() {
     ...
     *
     * Success is handled reactively: [UICApplication.paramsReadyFlow] emits `true`
     * when [UICApplication.applyTmsUpdate] succeeds, and Compose recomposes in place
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // background init coroutine in UICApplication completes, replacing the white screen.
        ...
        splashScreen.setKeepOnScreenCondition {
            !UICApplication.instance.appInitialized.value
        }

        // Register dynamic receiver for TMS params failure events.
        // Success is handled via UICApplication.paramsReadyFlow (no broadcast needed).
        ...
        setContent {
            ...
            UICMockAppTheme {
                val appInitialized by UICApplication.instance.appInitialized.collectAsState()
                val paramsAvailable by UICApplication.instance.paramsReadyFlow.collectAsState()
 ...
 * while UIC Home downloads the configuration from the TMS server.
 *
...
fun UICApp(
    ...
    val tmsDatabase = remember { UICApplication.instance.tmsDatabase }
                    ...
                    dst_MoreMenu.screen(
                        ...
                        { shortcut ->
                            ...
                            when (shortcut) {
                                ...
                                else -> navController.navigate(shortcut.route)
                            }
                        }
                    )
                }
                            ...
                            try {
                                ...
                                if (results.any { it is SettlementResult.Success }) {
                                    ...
                                    if (PendingUpdateManager.hasPendingAppUpdate(context)) {
                                        PendingUpdateManager.notifyUicHomeCanProceed(context)
