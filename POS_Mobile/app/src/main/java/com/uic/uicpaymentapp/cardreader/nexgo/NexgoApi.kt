 ...
 */
class NexgoApi(
    private val context: Context = UICApplication.instance,
    private val deviceEngine: DeviceEngine = UICApplication.deviceEngine,
) {
    ...
    companion object {
         ...
         * if one is already active. Called from [UICApplication.onCreate] on every cold start.
         ...
         * is already active. Called from [UICApplication.applyTmsUpdate] whenever new TMS
