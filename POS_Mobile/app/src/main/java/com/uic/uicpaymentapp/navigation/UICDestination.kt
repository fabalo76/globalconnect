...
import com.uic.uicpaymentapp.cardreader.CardReaderTestScreen
import com.uic.uicpaymentapp.profile.AppConfigScreen
import com.uic.uicpaymentapp.profile.ProfileScreen
import com.uic.uicpaymentapp.profile.AboutScreen
import com.uic.uicpaymentapp.profile.SystemSettingsScreen
import com.uic.uicpaymentapp.records.TransactionHistoryScreen
import com.uic.uicpaymentapp.records.ReportsScreen
import com.uic.uicpaymentapp.records.TotalsReportScreen
import com.uic.uicpaymentapp.records.ReprintSettlementScreen
import com.uic.uicpaymentapp.transaction.SaleScreen
import com.uic.uicpaymentapp.transaction.CardTransactionScreen
...
import com.uic.uicpaymentapp.profile.PasswordScreen
import com.uic.uicpaymentapp.records.EndOfDay
import com.uic.uicpaymentapp.settlement.SettlementRequest
import com.uic.uicpaymentapp.transaction.BatchScreen
import com.uic.uicpaymentapp.transaction.QuickTipScreen
import com.uic.uicpaymentapp.transaction.TransactionType
import com.uic.uicpaymentapp.transaction.toTransactionString
import com.uic.uicpaymentapp.parallel.echo.EchoTestScreen
import com.uic.uicpaymentapp.transaction.EditTransactionScreen
...
import com.uic.uicpaymentapp.transaction.hotel.HotelCheckInReportScreen
import com.uic.uicpaymentapp.transaction.hotel.HotelCheckInScreen
import com.uic.uicpaymentapp.transaction.hotel.HotelCheckOutScreen
...
private fun resolveAmountPromptConfig(transactionType: TransactionType): AmountPromptConfig {
    val db = UICApplication.instance.tmsDatabase
...
object dst_EndOfDay : UICDestination {
    ...
    //    override val label: String = UICApplication.instance.resources.getString(R.string.end_of_day)
    override fun getLabel(context: Context): String {
...
object dst_Reports : UICDestination {
    ...
    //    override val label: String = UICApplication.instance.resources.getString(R.string.reports)
    override fun getLabel(context: Context): String {
...
object dst_Profile : UICDestination {
    ...
    //    override val label: String = UICApplication.instance.resources.getString(R.string.profile)
    override fun getLabel(context: Context): String {
