package com.uic.uicpaymentapp.printer
...
import com.uic.uicpaymentapp.records.SummaryMetric
import com.uic.uicpaymentapp.records.buildSummaryReport
...
import com.uic.uicpaymentapp.records.toSignedAmount
import com.uic.uicpaymentapp.settlement.storage.SettlementSnapshot
import com.uic.uicpaymentapp.transaction.BatchSummary
import com.uic.uicpaymentapp.transaction.CVMType
import com.uic.uicpaymentapp.transaction.PrintableTotalsLine
import com.uic.uicpaymentapp.transaction.PrintableTotalsReport
import com.uic.uicpaymentapp.transaction.ReturnStatus
import com.uic.uicpaymentapp.transaction.ReversalReceiptData
...
import com.uic.uicpaymentapp.uicpos.pos.host.HostProtocolRegistry
...
object NexGoPaymentPrinter : PaymentPrinter {
    ...
    override fun printBatchReport(
        ...
        if (SysParam.Companion.getInstance().DetailedBatchReport) {
            printer.appendPrnStr(
                "Order # ${
                    UICApplication.Companion.instance.resources.getString(
                        R.string.type
                    )
                }  ${
                    UICApplication.Companion.instance.resources.getString(
                ...
                }   ${UICApplication.Companion.instance.resources.getString(R.string.amt)}",
                SMALLFONTSIZE,
                AlignEnum.LEFT,
                true
            )
            ...
            if (queryList.isEmpty()) {
                printer.appendPrnStr("          ", LARGEFONTSIZE, AlignEnum.CENTER, false)
                printer.appendPrnStr(
                    UICApplication.Companion.instance.resources.getString(R.string.no_data),
                    SMALLFONTSIZE,
                    AlignEnum.CENTER,
                    false
                )
        ...
        // Summary start
        printer.appendPrnStr(
            UICApplication.Companion.instance.resources.getString(R.string.summary_credit),
            "${batchSummary.creditRecords}",
            SMALLFONTSIZE,
            false
        )
        printer.appendPrnStr(
            UICApplication.Companion.instance.resources.getString(R.string.summary_credit_total),
            "$${batchSummary.creditTotal}", SMALLFONTSIZE, false
        )
        printer.appendPrnStr(
            UICApplication.Companion.instance.resources.getString(R.string.summary_tip_total),
        ...
        printer.appendPrnStr("          ", LARGEFONTSIZE, AlignEnum.CENTER, false)
        printer.appendPrnStr(
            UICApplication.Companion.instance.resources.getString(R.string.report_generated_on),
            SMALLFONTSIZE,
            AlignEnum.LEFT,
            false
        )
        ...
        printer.appendPrnStr("          ", LARGEFONTSIZE, AlignEnum.CENTER, false)
        printer.appendPrnStr(
            UICApplication.Companion.instance.resources.getString(R.string.end_of_report),
            LARGEFONTSIZE,
            AlignEnum.LEFT,
            false
        )
    ...
    override fun printTotalsReport(
        ...
        val resources = UICApplication.Companion.instance.resources
...
*/
        ...
        var entryMode = when (transaction.cardEntryMethod.uppercase()) {
            "SWIPE" -> UICApplication.Companion.instance.resources.getString(R.string.short_entrymode_MSR)
            "NFC" -> UICApplication.Companion.instance.resources.getString(R.string.short_entrymode_NFC)
            "EMV" -> UICApplication.Companion.instance.resources.getString(R.string.short_entrymode_EMV)
            "EMV_CONTACTLESS" -> UICApplication.Companion.instance.resources.getString(R.string.short_entrymode_EMVCTLS)
            "MANUAL" -> UICApplication.Companion.instance.resources.getString(R.string.short_entrymode_MANUAL)
            "FALLBACK_SWIPE" -> UICApplication.Companion.instance.resources.getString(R.string.short_entrymode_FALLBACK)
             else -> UICApplication.Companion.instance.resources.getString(R.string.short_entrymode_UNKNOWN)
        }
        entryMode = UICApplication.Companion.instance.resources.getString(R.string.entrymode_short , entryMode)

        val batchno = 1
        printer.appendPrnStr(entryMode, "${UICApplication.Companion.instance.resources.getString(R.string.batch)}#: ${FormatterUtils.paddedInteger(batchno, 6)}" , TINYFONTSIZE, false )
        ...
        printer.appendPrnStr("${UICApplication.Companion.instance.resources.getString(R.string.ext_ref)}: ", "${
            UICApplication.Companion.instance.resources.getString(
        ...
        if (transaction.returnStatus == ReturnStatus.Voided) {
            printer.appendPrnStr(UICApplication.Companion.instance.resources.getString(R.string.receipt_void_prefix), LARGEFONTSIZE, AlignEnum.LEFT, false)
        }
        ...
        if (tax1Present) {
            printer.appendPrnStr(" ${UICApplication.Companion.instance.resources.getString(R.string.Tax).uppercase()}",
                FormatterUtils.formatAmount(curSym, transaction.tax1Amount),SMALLFONTSIZE,false)
            if (tax1DiscountPresent)
            {
                printer.appendPrnStr("  ${UICApplication.Companion.instance.resources.getString(R.string.Tax_Discount).uppercase()}", "${FormatterUtils.formatAmount(curSym, transaction.tax1DiscountAmount.toBigDecimal().negate())}   ", SMALLFONTSIZE, false)
            }
        }
        if (tax2Present)
            printer.appendPrnStr(" ${UICApplication.Companion.instance.resources.getString(R.string.Tax2).uppercase()}" , FormatterUtils.formatAmount(curSym, transaction.tax2Amount), SMALLFONTSIZE, false)
        if (tipPresent)
            printer.appendPrnStr(" ${UICApplication.Companion.instance.resources.getString(R.string.Tip).uppercase()}", FormatterUtils.formatAmount(curSym, transaction.tipAmount), SMALLFONTSIZE, false)

        printer.appendPrnStr("-".repeat(CHARSPERLINE_SMALLFONTSIZE/3), SMALLFONTSIZE, AlignEnum.RIGHT, false)
        printer.appendPrnStr(UICApplication.Companion.instance.resources.getString(R.string.Total).uppercase(), FormatterUtils.formatAmount(curSym, transaction.totalAmount), LARGEFONTSIZE, false)
        ...
        if (transaction.type != TransactionType.REFUND && transaction.returnStatus != ReturnStatus.Voided) {
            if (transaction.CVM == CVMType.PinVerified) {
                printer.appendPrnStr(UICApplication.Companion.instance.resources.getString(R.string.PinVerified), SMALLFONTSIZE, AlignEnum.CENTER, true)
            }
            if (SysParam.Companion.getInstance().signatureMode != SignatureMode.None
                || transaction.CVM == CVMType.Signature) {
                val signaturetext = UICApplication.Companion.instance.resources.getString(R.string.receipt_signature)
                if (bitmap == null) {
                    printer.appendPrnStr("          ", LARGEFONTSIZE, AlignEnum.CENTER, false)
                    printer.appendPrnStr("          ", LARGEFONTSIZE, AlignEnum.CENTER, false)
                    ...
                    val agreement1 = UICApplication.Companion.instance.resources.getString(R.string.receipt_agreement_1).uppercase().trim()
                    val agreement2 = UICApplication.Companion.instance.resources.getString(R.string.receipt_agreement_2).uppercase().trim()
                    val agreement3 = UICApplication.Companion.instance.resources.getString(R.string.receipt_agreement_3).uppercase().trim()
        ...
        if ((transaction.cardEntryMethod == "EMV")||(transaction.cardEntryMethod == "EMV_CONTACTLESS")) {
            val emvinfolabel = UICApplication.Companion.instance.resources.getString(R.string.emv_information)
            ...
            printer.appendPrnStr("${UICApplication.Companion.instance.resources.getString(R.string.TVR)} ${transaction.TVR}", "${UICApplication.Companion.instance.resources.getString(
                    R.string.TSI)} ${transaction.TSI}", TINYFONTSIZE, false)
            printer.appendPrnStr("${UICApplication.Companion.instance.resources.getString(R.string.ARC)} ${transaction.ARC}", "${UICApplication.Companion.instance.resources.getString(
        ...
        if (recipient == MERCHANT) {
            printer.appendPrnStr(UICApplication.Companion.instance.resources.getString(R.string.merchant_copy), MINFONTSIZE, AlignEnum.CENTER, false)
        } else {
            printer.appendPrnStr(UICApplication.Companion.instance.resources.getString(R.string.customer_copy), MINFONTSIZE, AlignEnum.CENTER, false)
        }
        printer.appendPrnStr(
            UICApplication.Companion.instance.resources.getString(R.string.poweredbyuic), MINFONTSIZE,
            AlignEnum.CENTER,false)

        val versionText = "${UICApplication.Companion.instance.resources.getString(R.string.version)}: ${UICApplication.Companion.instance.appVersion}"
    ...
    override fun printReversalReceipt(
        ...
        val invoiceLabel = UICApplication.Companion.instance.resources.getString(R.string.invoice_short)
        ...
        printer.appendPrnStr(
            UICApplication.Companion.instance.getString(R.string.receipt_transaction_reversed),
            MASSIVEFONTSIZE,
            AlignEnum.CENTER,
            true
        )
    ...
    override fun printConfigReport(context: Context, tmsDatabase: TMSDATA) {
        ...
        printer.printLine("No. Serie [${UICApplication.serialNumber}]", PrintFontSize.TINY)
        ...
        printer.printLine(dottedSpacer, PrintFontSize.SMALL)
        printer.printCentered(UICApplication.instance.getString(R.string.end_of_report), PrintFontSize.LARGE, isBold = false)
