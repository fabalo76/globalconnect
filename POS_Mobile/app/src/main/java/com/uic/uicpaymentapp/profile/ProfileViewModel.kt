...
data class ProfileUiState(
    var businessName: ProfileOption = ProfileOption(
        text = "",
        label = UICApplication.instance.resources.getString(R.string.profile_business_name),
        type = ProfileOptionsType.Name
    ),
    var email: ProfileOption = ProfileOption(
        text = "",
        label = UICApplication.instance.resources.getString(R.string.profile_email),
        type = ProfileOptionsType.Email
    ),
    var phoneNumber: ProfileOption = ProfileOption(
        text = "",
        label = UICApplication.instance.resources.getString(R.string.profile_phone_number),
        type = ProfileOptionsType.PhoneNumber
    ),
    var streetAddress: ProfileOption = ProfileOption(
        text = "",
        label = UICApplication.instance.resources.getString(R.string.profile_street_address),
        type = ProfileOptionsType.Address
    ),
    var cityState: ProfileOption = ProfileOption(
        text = "",
        label = UICApplication.instance.resources.getString(R.string.profile_city_state),
        type = ProfileOptionsType.CityState
    ),
    var zipCode: ProfileOption = ProfileOption(
        text = "",
        label = UICApplication.instance.resources.getString(R.string.profile_zip_code),
...
enum class ProfileOptionsType {
    ...
    fun toUserLabel(): String {
        return when (this) {
            Name -> UICApplication.instance.resources.getString(R.string.profile_business_name)
            Email -> UICApplication.instance.resources.getString(R.string.profile_email)
            PhoneNumber -> UICApplication.instance.resources.getString(R.string.profile_phone_number)
            Address -> UICApplication.instance.resources.getString(R.string.profile_street_address)
            CityState -> UICApplication.instance.resources.getString(R.string.profile_city_state)
            ZipCode -> UICApplication.instance.resources.getString(R.string.profile_zip_code)
        }
    }
}
