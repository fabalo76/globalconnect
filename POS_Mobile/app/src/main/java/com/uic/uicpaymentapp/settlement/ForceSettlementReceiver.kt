...
import com.uic.uicpaymentapp.PendingUpdateManager
...
private const val ACTION_FORCE_SETTLEMENT = "com.uic.home.ACTION_FORCE_SETTLEMENT"
...
class ForceSettlementReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val app = context.applicationContext as UICApplication
                ...
                try {
                    ...
                    if (results.any { it is SettlementResult.Success }) {
                        ...
                        if (PendingUpdateManager.hasPendingAppUpdate(app.applicationContext)) {
                            PendingUpdateManager.notifyUicHomeCanProceed(app.applicationContext)
