...
import com.uic.uicpaymentapp.records.CardIcon
import com.uic.uicpaymentapp.records.defaultFormattedVerboseDateTime
import com.uic.uicpaymentapp.ui.theme.color_Green80
import com.uic.uicpaymentapp.ui.theme.color_Pink80
import com.uic.uicpaymentapp.ui.theme.color_Purple40
import com.uic.uicpaymentapp.ui.theme.color_Yellow80
...
fun EditTransactionScreen(
    ...
    when (screenToShow) {
        TransactionViewScreen.MainScreen -> TransactionMainScreen(
            ...
            onRefundPressed = {
                val voidPassword = UICApplication.instance.tmsDatabase.Terminal
        ...
        Column(
            ...
            Column(
                ...
                val tipEnabled = if (isPreview) true else remember(transaction.acquirerId) {
                    UICApplication.instance.tmsDatabase.Acquirer
...
private fun VoidPasswordDialog(onAuthenticated: () -> Unit, onDismiss: () -> Unit) {
    ...
    val expectedPassword = remember {
        val pwd = UICApplication.instance.tmsDatabase.Terminal.firstOrNull()?.password ?: 0L
        "%04d".format(pwd)
    }
