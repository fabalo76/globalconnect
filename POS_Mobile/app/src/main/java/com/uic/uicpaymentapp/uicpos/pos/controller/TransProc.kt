...
import com.uic.uicpaymentapp.uicpos.pos.host.HostAddress
import com.uic.uicpaymentapp.uicpos.pos.host.HostSettingsResolver
import com.uic.uicpaymentapp.uicpos.pos.host.toHexString
import com.uic.uicpaymentapp.uicpos.pos.model.ProcInfo
import com.uic.uicpaymentapp.uicpos.pos.model.ReqCmd
import com.uic.uicpaymentapp.uicpos.pos.model.SysParam
import com.uic.uicpaymentapp.uicpos.pos.transceiver.BaseSocketClient
import com.uic.uicpaymentapp.uicpos.pos.transceiver.SSLClient
import com.uic.uicpaymentapp.uicpos.pos.transceiver.SocketClientRecvMsgListener
import com.uic.uicpaymentapp.uicpos.pos.transceiver.TcpClient
import com.uic.uicpaymentapp.uicpos.pos.util.DispUtil
import com.uic.uicpaymentapp.uicpos.pos.util.document
import com.uic.uicpaymentapp.uicpos.pos.util.element
...
//        }
    ...
    private fun transmitWithEndpoint(
        ...
        do {
            dispUtil.dispMsg(
                UICApplication.instance.resources.getString(R.string.msg_comm_title),
                UICApplication.instance.resources.getString(R.string.msg_comm_connecting)
            )
            ...
            dispUtil.dispMsg(
                UICApplication.instance.resources.getString(R.string.msg_comm_title),
                UICApplication.instance.resources.getString(R.string.msg_comm_send)
            )
            ...
            dispUtil.dispMsg(
                UICApplication.instance.resources.getString(R.string.msg_comm_title),
                UICApplication.instance.resources.getString(R.string.msg_comm_recv)
            )
            while (true) {
                Thread.sleep(1)
