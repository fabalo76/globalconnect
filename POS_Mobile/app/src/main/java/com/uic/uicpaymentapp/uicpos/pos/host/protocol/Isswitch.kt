...
import com.uic.uicpaymentapp.uicpos.pos.host.EntryModeMapper
import com.uic.uicpaymentapp.uicpos.pos.host.HostProtocol
import com.uic.uicpaymentapp.uicpos.pos.host.HostProtocolContext
import com.uic.uicpaymentapp.uicpos.pos.host.HostProtocolException
...
import com.uic.uicpaymentapp.uicpos.pos.host.protocol.PrivateUseData63.Tag
...
class Isswitch(
    ...
    override fun buildIsoMessage(context: HostProtocolContext) = try {
        ...
        message.setFieldValue(3, transactionConfig.processingCode)
        fieldValues[3] = transactionConfig.processingCode
