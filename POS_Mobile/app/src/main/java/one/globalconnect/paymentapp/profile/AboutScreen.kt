...
import one.globalconnect.paymentapp.transaction.TransactionErrorDialog
        ...
        Column(
            ...
            Column(
                ...
                Column(
                    ...
                    val capkLabel = when (
                        GlobalConnectPaymentApplication.instanceOrNull?.tmsDatabase?.Terminal?.firstOrNull()?.CAPKKEyConfig
                    ) {
