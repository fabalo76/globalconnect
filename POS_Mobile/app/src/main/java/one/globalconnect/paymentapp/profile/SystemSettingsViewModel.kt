...
import one.globalconnect.paymentapp.uicpos.pos.model.toTransactionMode
...
data class SystemUiState(
    var cmdTout: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_command_timeout),
        type = SystemSettingType.CmdTout,
        maxLength = 3
    ),
    var password: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.password),
        type = SystemSettingType.Password,
        maxLength = 6
    ),
    var transactionMode: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.restaurant_mode),
        type = SystemSettingType.TransactionMode,
        maxLength = 5
    ),
    var tipMethod: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.tip_methods),
        type = SystemSettingType.TipMethod,
        maxLength = 5
    ),
    var signatureMode: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_signature_required),
        type = SystemSettingType.SignatureMode,
        maxLength = 10
    ),
    var language: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.language),
    ...
    var tipOption1: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_1),
        type = SystemSettingType.TipSetting1,
        maxLength = 3,
        text = "15"
    ),
    var tipOption2: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_2),
        type = SystemSettingType.TipSetting2,
        maxLength = 3,
        text = "18"
    ),
    var tipOption3: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_3),
        type = SystemSettingType.TipSetting3,
        maxLength = 3,
        text = "20"
    ),
    var tipOption4: SystemSetting = SystemSetting(
        label = GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_4),
...
enum class SystemSettingType {
    ...
    fun toUserLabel(): String {
        return when (this) {
            CmdTout -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_command_timeout)
            Password -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.password)
            TransactionMode -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_device_mode)
            TipMethod -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.tip_methods)
            SignatureMode -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_signature_required)
            Language -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.language)
            BatchPrint -> "Auto-print Batch Report"
            DetailedBatchReport -> "Print Transactions on Report"
            OptionsEnabled -> "Tip Options Enabled"
            TipSetting1 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_1)
            TipSetting2 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_2)
            TipSetting3 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_3)
            TipSetting4 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_option_4)
        }
    }

    fun getErrorString(): String {
        return when (this) {
            CmdTout -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_connection_30_to_120_input_err)
            Password -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_password_input_err)
            TransactionMode -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_input_err)
            TipMethod -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_input_err)
            SignatureMode -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_input_err)
            Language -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_language_input_err)
            TipSetting1 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_input_err)
            TipSetting2 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_input_err)
            TipSetting3 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_input_err)
            TipSetting4 -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_tip_input_err)
            OptionsEnabled -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_input_err)
            BatchPrint -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_input_err)
            DetailedBatchReport -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.setting_input_err)
        }
    }
}
