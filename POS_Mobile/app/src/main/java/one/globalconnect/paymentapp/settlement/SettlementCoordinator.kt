...
import one.globalconnect.paymentapp.transaction.toPrinterString
...
import one.globalconnect.paymentapp.uicpos.pos.host.HostTransactionSession
...
class SettlementCoordinator(
    ...
    private val settlementStateRepository: SettlementStateRepository =
        GlobalConnectPaymentApplication.instance.container.settlementStateRepository,
    ...
    private fun buildUploadProcInfo(
        ...
        transLog.OriginalTax1Amt = Tax1DiscountCalculator.originalTaxAmountFromDiscounted(
