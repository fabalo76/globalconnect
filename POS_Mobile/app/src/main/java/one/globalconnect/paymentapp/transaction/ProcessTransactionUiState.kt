...
import one.globalconnect.paymentapp.uicpos.pos.util.ApplSelectViewData
            ...
            StateType.PARTIAL -> {
                if (baseAmount.isBlank()) {
                    ...
                    ProcessTransactionUiState.PARTIALAPPROVAL(
                        message = GlobalConnectPaymentApplication.instance.resources.getString(
...
//        "31" -> TerminalMessage.WAITING(context.getString(R.string.msg_31))
        ...
        return when (errorCode) {
            null -> TerminalMessage.FAILED("Error code was null")
                ...
                Log.d("MsgIdToMsg", GlobalConnectPaymentApplication.instance.getString(errorCode.getId()))
                TerminalMessage.CONNECTIONFAILED(GlobalConnectPaymentApplication.instance.getString(errorCode.getId()))
            }
        }
