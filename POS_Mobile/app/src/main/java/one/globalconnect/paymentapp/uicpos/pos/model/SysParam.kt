...
enum class TransactionMode {
    ...
    override fun toString(): String {
        return when (this) {
            Restaurant -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.restaurant_mode)
            Retail -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.retail_mode)
            Cafe -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.cafe_mode)
        }
    }
}
...
enum class SignatureMode {
    ...
    override fun toString(): String {
        return when (this) {
            OnScreen -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.signature_mode_on_screen)
            OnReceipt -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.signature_mode_on_receipt)
            None -> GlobalConnectPaymentApplication.instance.resources.getString(R.string.signature_mode_none)
        }
    }
}
