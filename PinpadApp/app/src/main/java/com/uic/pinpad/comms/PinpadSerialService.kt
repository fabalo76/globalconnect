...
import com.uic.pinpad.BuildConfig
import com.uic.pinpad.MainActivity
import com.uic.pinpad.PinpadApplication
import com.uic.pinpad.R
import com.uic.pinpad.logging.PinpadTraceLog
import com.uic.pinpad.protocol.PinpadProtocolFactory
import com.uic.pinpad.protocol.PinpadProtocolHandler
...
import com.uic.pinpad.transport.PINPADTransport
import com.uic.pinpad.transport.CompositeTransport
import com.uic.pinpad.transport.NexgoRs232Transport
import com.uic.pinpad.transport.NexgoUsbCdcTransport
import com.uic.pinpad.transport.NoOpTransport
...
class PinpadSerialService : Service(), PINPADTransport.Listener {
    ...
    companion object {
        const val ACTION_RELOAD_SETTINGS = "com.uic.pinpad.action.RELOAD_PINPAD_SETTINGS"
        const val ACTION_CANCEL_ACTIVE_OPERATION = "com.uic.pinpad.action.CANCEL_ACTIVE_OPERATION"
        const val ACTION_KEYPAD_KEY = "com.uic.pinpad.action.KEYPAD_KEY"
        const val EXTRA_KEYPAD_KEY = "com.uic.pinpad.extra.KEYPAD_KEY"
