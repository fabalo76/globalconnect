# Continental Payment Systems — Outlook signature
...
1. Close Outlook.
2. Copy `Continental Payment Systems.htm`, `Continental Payment Systems.txt`, and the complete `Continental Payment Systems_files` folder into `%APPDATA%\Microsoft\Signatures`.
3. Reopen Outlook and go to **File → Options → Mail → Signatures**.
4. Select **Continental Payment Systems** for new messages and replies/forwards.
